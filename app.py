...
# ── Step 1: Gemini AI fruit identification ────────────────────────────────────
def identify_fruit_gemini(image_b64, mime_type="image/jpeg"):
    prompt = """Look at this image and identify the fruit. Reply with ONLY a JSON object like this:
{"fruit": "apple", "confidence": 0.95}
Use lowercase fruit name. If not a fruit, use "unknown"."""
    payload = {
        "contents": [{
            "parts": [
...
def analyse():
    try:
        ...
        # Step 1: Identify fruit with Gemini
        try:
